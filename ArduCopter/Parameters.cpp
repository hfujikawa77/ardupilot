...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate,27:SpiralAcro
    // @User: Standard
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Param: SPIRALACRO_OPTIONS
    // @DisplayName: Spiralacro mode options
    // @Description: Options that can be applied to change spiralacro mode behaviour
    // @Bitmask: 0:Allow Arming from Transmitter
    // @User: Advanced
    AP_GROUPINFO("SPIRAL_ACRO", 43, ParametersG2, spiralacro_options, 0),
#endif
